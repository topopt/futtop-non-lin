...
entry solveSystemLinear [nelx][nely][nelz][nx][ny][nz] (xPhys :[nelx][nely][nelz]f32) (mgData :multigridData) (uold :[nx][ny][nz][3]f32) (f :[nx][ny][nz][3]f32) =
  cgSolveMG 1e-5 200 xPhys mgData f uold

-- Update design variables x given displacement field and volume fraction.
entry designIterationLinear [nelx][nely][nelz][nx][ny][nz] (x :[nelx][nely][nelz]f32) (xPhys :[nelx][nely][nelz]f32) (u :[nx][ny][nz][3]f32) (volfrac :f32) (rmin :f32) =
