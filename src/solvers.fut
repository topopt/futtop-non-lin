...
def cgSolveMG [nelx][nely][nelz][nx][ny][nz] tol maxIt (x :[nelx][nely][nelz]f32) (mgData :multigridData) (b :[nx][ny][nz][3]f32) (u :[nx][ny][nz][3]f32) =
  let bnorm   = norm b
  let zero_4d = replicate nx (replicate ny (replicate nz [0f32,0f32,0f32]))
