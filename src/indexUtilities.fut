...
def toVoigtVector (v :[3][3]f64) =
  #[unsafe] ([v[0,0],v[1,1],v[2,2],v[1,2],v[2,0],v[0,1]])

def toVoigtMatrix (v :[3][3][3][3]f64) =
   #[unsafe]([[v[0,0,0,0],v[0,0,1,1],v[0,0,2,2],v[0,0,1,2],v[0,0,2,0],v[0,0,0,1]],
              [v[0,0,1,1],v[1,1,1,1],v[1,1,2,2],v[1,1,1,2],v[1,1,2,0],v[1,1,0,1]],
              [v[0,0,2,2],v[1,1,2,2],v[2,2,2,2],v[2,2,1,2],v[2,2,2,0],v[2,2,0,1]],
              [v[0,0,1,2],v[1,1,1,2],v[2,2,1,2],v[1,2,1,2],v[1,2,2,0],v[1,2,0,1]],
              [v[0,0,2,0],v[1,1,2,0],v[2,2,2,0],v[1,2,2,0],v[2,0,2,0],v[2,0,0,1]],
              [v[0,0,0,1],v[1,1,0,1],v[2,2,0,1],v[1,2,0,1],v[2,0,0,1],v[0,1,0,1]]])
